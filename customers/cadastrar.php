        ...
        <div class="col-sm-auto col-md-auto col-lg-auto mx-auto">
            <div class="card card-signin my-5">
                <div class="card-body">
                    ...
                    <form class="form-signin" action="createCadastro.php" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <div class="form-label-group">
                                    <input name="usuario" type="text" class="form-control" id="inputUsuario" placeholder="Usuário" autocomplete="off" required>
                        ...
                        <div class="form-group">
                            <div class="form-label-group">
                                <input name="end" type="text" class="form-control" id="inputAddress" placeholder="Endereço" autocomplete="off" required>
                                <label for="inputAddress">Endereço</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-label-group">
                                <input name="cel" type="number" class="form-control" id="inputPhone" placeholder="Endereço" autocomplete="off" required>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <div class="form-label-group">
                                    <input name="cpf" type="number" class="form-control" id="inputCpf" placeholder="Endereço" autocomplete="off" required>
                            ...
                            <div class="form-group col-md-6">
                                <div class="form-label-group">
                                    <input name="rg" type="number" class="form-control" id="inputRg" placeholder="Endereço" autocomplete="off" required>
